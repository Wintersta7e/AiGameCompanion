<!--
  Ambient background. Deliberately quiet — the per-game accent provides the
  colour, so this is just two slow, low-opacity orbs over near-black. No
  scanlines (they read cheap and fight with game cover art).
-->
